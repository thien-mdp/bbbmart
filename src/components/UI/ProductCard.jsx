        ...
        <div className="product__item cursor-pointer xs:mx-0 md:mx-5 xs:bg-white md:bg-transparent xs:p-5 md:p-0 rounded-[5px]">
            <div className='relative mb-2'>
                <p onClick={navigateToItem} className=' flex items-center text-center h-[250px]'>
                    <img loading="auto" alt="product image transition duration-500 ease-in-out" className='scale-100 hover:scale-[0.85] ease-in-out duration-500 max-h-[220px] h-full w-full bg-cover min-w-auto rounded-[5px]' src={item.thumbnail} />
                </p>
            ...
            <div className='px-4 pb-2'>
                ...
                <div className='flex justify-between items-center mt-1'>
                    ...
                    <BsFillBagPlusFill
                        onClick={addToCart}
                        className='text-xl hover:text-red-600 font-bold'
                    />
                </div>
            </div>
        </div>
