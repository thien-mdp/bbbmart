            ...
            <div className='!min-w-[35%] text-xl text-center'>
              <div className=''>
                ...
                <div className='bg-white border border-solid border-gray mx-3 py-5 relative bottom-3 text-lg'>
                  ...
                  {/* <Divider /> */}
                  <h1 onClick={navigateToHome} className='cursor-pointer hover:text-teal-600 font-ConCung text-xl h-10 justify-center flex items-center' type="primary"> <TiArrowBack className='mr-2' />Tiếp tục mua sắm </h1>
                  <div className='my-5 mx-2'>
                    <Button onClick={navigateToCheckout} className='bg-teal-600 font-ConCung text-xl h-10 text-center w-full' type="primary">Thanh toán</Button>
                  </div>
                  <div className="absolute box-border bottom-[-20px] w-full h-[35px] bg-repeat-x bg-[url('assets/img/bg-end-cart.svg')]" style={{ backgroundPositionX: "-3px", backgroundPositionY: "-3px" }} />
                </div>
              </div>
