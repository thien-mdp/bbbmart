        ...
        !loading ? (
          <section className='xs:mx-2 md:mx-[20%] min-h-[90vh] font-mono'>
            <div className='flex my-10'>
              <div className='w-[65%] flex'>
                ...
                <div className='w-[80%] h-auto mt-1 ml-2'>
                  <ImageMagnifier
                    style={"object-cover mx-auto min-w-full h-auto min-h-[400px] cursor-zoom-in"}
              ...
              <div className='w-[35%] ml-10'>
                ...
                <div className='py-2 '>
                  <div className='xs:grid lg:flex items-center'>
                    <InputNumber min={1} max={product.stock} defaultValue={1} onChange={(value)=>setQuantity(value)} className='min-w-[40px] w-auto' />
                    <h1
                      onClick={addToCart}
                  ...
                  <Button 
                    onClick={buyNow} 
                    className='w-full mt-3 h-auto bg-blue-500  font-bold !text-white text-base hover:bg-blue-700 py-1'
                  >
                    Mua ngay
                  </Button>
                </div>
            ...
            <div>
              ...
              <p className='font-base'>Khăn ướt Mamamy với thiết kế nhỏ gọn, tiện cầm tay và đút túi dùng trong những chuyến đi xa, du lịch cùng gia đình, bè bạn. Sản phẩm có nắp đậy giúp giữ ẩm và bảo quản khăn, tránh nhiễm khuẩn ngược.
                Khăn ướt VS Mamamy 100 tờ, có nắp, không mùi
                Vải không dệt,hàm lượng sợi 60%, dầy, mềm mại không xơ, độ đàn hồi cao, dẫn xuất đường glucose từ nho thiên nhiên giúp giữ ẩm và làm mềm da được cấp bằng sáng chế số US8877703B2 của hoa kỳ,coco phospatidyl PG - Dimonium chloride  có tác dụng chống hăm, chống rôm sẩy được cấp bằng sáng chế số US 7803746B2 của hoa kỳ, chlorhexidine gluconate solution* có tác dụng kháng khuẩn WHO chỉ định trong nước xúc miệng, thích hợp cho da em bé kể cả da nhạy cảm
                Thành phần : Vải không dệt, nước tinh khiết 99,9%, coco phospatidyl PG - Dimonium chloride, stearyldimoniumhydroxypropyl laurylgluccosides chloride, chlorhexidine gluconate solution* (13 - tetraazatertradecanediimidamide 4 - chlorophenyl, 12 diimi - no - di  -D - gluconate; hexamethlenebis
                THÔNG TIN SẢN PHẨM
                Thương hiệu : Mamamy
                ...
                HƯỚNG DẪN SỬ DỤNG
                Mở nắp, bóc bỏ miếng decal phía trong, rút từng chiếc khăn sử dụng. Sau khi sử dụng xong đóng nắp lại để giữ ẩm và chống nhiễm khuẩn
                HƯỚNG DẪN BẢO QUẢN
                Bảo quản nơi khô mát, tránh ánh nắng trực tiếp và những nơi có nhiệt độ cao
                Chú ý : Sản phẩm không tan trong nước
              </p>
            </div>
            <Divider />
            <div className='my-10'>
              <h1 className='text-2xl font-bold p-2 text-red-600 flex items-center max-w-max mb-2'>Sản phẩm tương tự <BsFillCaretRightFill className='ml-1' /></h1>
            ...
            <div className='my-10'>
              <h1 className='text-2xl font-bold p-2 text-red-600 flex items-center max-w-max mb-2'>Sản phẩm khác <BsFillCaretRightFill className='ml-1' /></h1>
            ...
            <div className='Rating'>
              ...
              >
                <Form.Item
                  ...
                  rules={[{ required: true, message: 'Bạn chưa nhập tên nè >"<' }]}
                >
                  <Input
                    className='!w-full'
                ...
                <Form.Item
                  name="rate"
                  rules={[{ required: true, message: 'Bạn quên đánh giá sản phẩm rồi nè :P' }]}
                >
                  <Rate onChange={(value) => setRating(value)} />
                </Form.Item>
                <Form.Item
                  name="msg"
                  rules={[{ required: true, message: 'Bạn chưa nhập nội dung phản hồi!!' }]}
                >
                  <Input.TextArea
